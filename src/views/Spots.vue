          ...
          <div class="row">
            <div class="col-5">
              ...
              <span class="text-muted"
                >Ki. Bakau Griya Utama No. 476, DKI Jakarta</span
              >
            </div>
            <div class="col-4">
              <h5>Available vaccines</h5>
              <span class="text-muted"
                >Sinovac, AstraZeneca, Moderna, Pfizer.</span
              >
            </div>
            <div class="col-3">
              <h5>Serve</h5>
        ...
        <article class="spot">
          <div class="row">
            <div class="col-5">
              ...
              <span class="text-muted"
                >Ki. Bagis Utama No. 325, DKI Jakarta</span
              >
            </div>
            <div class="col-4">
              <h5>Available vaccines</h5>
        ...
        <article class="spot">
          <div class="row">
            <div class="col-5">
              ...
              <span class="text-muted"
                >Gg. Sam Ratulangi No. 503, DKI Jakarta</span
              >
            </div>
            <div class="col-4">
              <h5>Available vaccines</h5>
